          ...
          <div class="tour-panels">
            ...
            <section class="tour-panel" id="golens-tour-diff" role="tabpanel" aria-labelledby="golens-tour-tab-diff" tabindex="0" hidden>
              ...
              <ul class="feature-list">
                ...
                <li class="feature">${onboardingFeatureIcon('generated')}<div><strong>Optionally hide generated files</strong><p>Hide <span class="feature-note">.gitattributes</span>-marked files while keeping large collapsed files visible. Optionally hide root <span class="feature-note">.gitattributes</span> <span class="feature-note">-diff</span> files too; GitLab totals stay visible with a recalculated total beside them.</p></div></li>
