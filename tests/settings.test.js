...
test('tabbed settings manage preferences, shortcuts, host access, cache, and help', async () => {
  ...
  assert.equal(window.document.querySelector('[data-setting="hideNoDiffAttributes"]').checked, false);
  ...
  assert.equal(window.document.querySelectorAll('[data-shortcut-binding]').length, 15);
