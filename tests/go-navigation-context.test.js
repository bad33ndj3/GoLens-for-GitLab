...
before(async () => {
  ...
  // A bare document, kept for the suite's lifetime so helpers reading
  // document (e.g. fetchTreeEntries's CSRF-token lookup) don't depend on a
  // DOM-heavy test elsewhere in the file happening to run first and leaving
  // its own window.document assigned globally.
